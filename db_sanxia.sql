/*
 ...
 Source Schema         : db_sanxia

 Target Server Type    : MySQL
 Target Server Version : 80037
 File Encoding         : 65001

 Date: 27/06/2024 08:30:53
*/
...
INSERT INTO `category` VALUES (704, '21世纪新乐器', NULL, 692, 1, 0, '2024-06-26 17:14:59', '2024-06-26 17:14:59', 0);
...
CREATE TABLE `product_spec`  (
  ...
  `is_deleted` tinyint NOT NULL DEFAULT 0 COMMENT '删除标记（0:不可用 1:可用）',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '商品规格' ROW_FORMAT = Dynamic;
...
-- ----------------------------
INSERT INTO `sys_oper_log` VALUES (64, '角色管理:修改', 'edu.ctgu.sanxia.system.controller.SysRoleController.updateById()', 'PUT', 'MANAGE', NULL, '/admin/system/sysRole/updateById', '0:0:0:0:0:0:0:1', '{\"createTime\":1683196582000,\"roleCode\":\"yhgly\",\"roleName\":\"用户管理员\",\"description\":\"用户管理员\",\"id\":10}', '{\"code\":200,\"message\":\"成功\"}', 1, NULL, '2023-06-02 08:53:25', NULL, 0);
INSERT INTO `sys_oper_log` VALUES (65, '角色管理:修改', 'edu.ctgu.sanxia.system.controller.SysRoleController.updateById()', 'PUT', 'MANAGE', 'admin', '/admin/system/sysRole/updateById', '0:0:0:0:0:0:0:1', '{\"createTime\":1683196566000,\"roleCode\":\"ptgly\",\"roleName\":\"平台管理员\",\"description\":\"平台管理员\",\"id\":9}', '{\"code\":200,\"message\":\"成功\"}', 1, NULL, '2023-06-02 09:03:31', NULL, 0);
INSERT INTO `sys_oper_log` VALUES (66, '品牌管理:修改', 'edu.ctgu.sanxia.product.controller.BrandController.updateById()', 'PUT', 'MANAGE', 'admin', '/admin/product/brand/updateById', '117.173.208.34', '{\"createTime\":1683365427000,\"name\":\"小米\",\"logo\":\"http://139.198.127.41:9000/sph/20230506/小米.png\",\"id\":1}', '{\"code\":200,\"message\":\"成功\"}', 1, NULL, '2023-06-02 09:40:24', NULL, 0);
INSERT INTO `sys_oper_log` VALUES (67, '角色管理:新增', 'edu.ctgu.sanxia.system.controller.SysRoleController.save()', 'POST', 'MANAGE', 'admin', '/admin/system/sysRole/save', '0:0:0:0:0:0:0:1', '{\"roleCode\":\"1\",\"roleName\":\"1\",\"description\":\"1\",\"id\":27}', '{\"code\":200,\"message\":\"成功\"}', 1, NULL, '2023-06-25 10:13:43', NULL, 0);
INSERT INTO `sys_oper_log` VALUES (68, '角色管理:新增', 'edu.ctgu.sanxia.system.controller.SysRoleController.save()', 'POST', 'MANAGE', 'admin', '/admin/system/sysRole/save', '0:0:0:0:0:0:0:1', '{\"roleCode\":\"12\",\"roleName\":\"12\",\"description\":\"12\",\"id\":28}', '{\"code\":200,\"message\":\"成功\"}', 1, NULL, '2023-06-25 10:14:54', NULL, 0);
INSERT INTO `sys_oper_log` VALUES (69, '角色管理:修改', 'edu.ctgu.sanxia.system.controller.SysRoleController.updateById()', 'PUT', 'MANAGE', 'admin', '/admin/system/sysRole/updateById', '0:0:0:0:0:0:0:1', '{\"roleCode\":\"112\",\"roleName\":\"112\",\"description\":\"112\",\"id\":28}', NULL, 0, NULL, '2023-06-25 10:15:38', NULL, 0);
INSERT INTO `sys_oper_log` VALUES (70, '角色管理:修改', 'edu.ctgu.sanxia.system.controller.SysRoleController.updateById()', 'PUT', 'MANAGE', 'admin', '/admin/system/sysRole/updateById', '0:0:0:0:0:0:0:1', '{\"roleCode\":\"112\",\"roleName\":\"112\",\"description\":\"112\",\"id\":28}', NULL, 0, NULL, '2023-06-25 10:16:36', NULL, 0);
INSERT INTO `sys_oper_log` VALUES (71, '角色管理:修改', 'edu.ctgu.sanxia.system.controller.SysRoleController.updateById()', 'PUT', 'MANAGE', 'admin', '/admin/system/sysRole/updateById', '0:0:0:0:0:0:0:1', '{\"roleCode\":\"112\",\"roleName\":\"112\",\"description\":\"112\",\"id\":28}', '{\"code\":200,\"message\":\"成功\"}', 1, NULL, '2023-06-25 10:23:35', NULL, 0);
INSERT INTO `sys_oper_log` VALUES (72, '角色', 'edu.ctgu.sanxia.controller.SysRoleController', 'GET', 'MANAGE', 'zhangsan', '/admin/system/sysRole/findByPage/1/3', '0:0:0:0:0:0:0:1', NULL, '{\"code\":200,\"data\":{\"endRow\":3,\"hasNextPage\":true,\"hasPreviousPage\":false,\"isFirstPage\":true,\"isLastPage\":false,\"list\":[{\"createTime\":\"2023-07-19 14:09:32\",\"id\":34,\"isDeleted\":0,\"roleCode\":\"aaa\",\"roleName\":\"aaa\",\"updateTime\":\"2023-07-19 14:09:32\"},{\"createTime\":\"2023-07-18 14:36:22\",\"id\":33,\"isDeleted\":0,\"roleCode\":\"test\",\"roleName\":\"测试\",\"updateTime\":\"2023-07-18 14:36:22\"},{\"createTime\":\"2023-07-18 14:05:18\",\"id\":32,\"isDeleted\":0,\"roleCode\":\"test\",\"roleName\":\"test\",\"updateTime\":\"2023-07-18 14:05:18\"}],\"navigateFirstPage\":1,\"navigateLastPage\":2,\"navigatePages\":8,\"navigatepageNums\":[1,2],\"nextPage\":2,\"pageNum\":1,\"pageSize\":3,\"pages\":2,\"prePage\":0,\"size\":3,\"startRow\":1,\"total\":5},\"message\":\"操作成功\"}', 0, NULL, '2023-07-19 14:26:14', NULL, 0);
INSERT INTO `sys_oper_log` VALUES (73, '角色添加', 'edu.ctgu.sanxia.controller.SysRoleController', 'POST', 'MANAGE', 'zhangsan', '/admin/system/sysRole/saveSysRole', '0:0:0:0:0:0:0:1', '{\"roleCode\":\"bbb\",\"roleName\":\"bbb\"}', '{\"code\":200,\"message\":\"操作成功\"}', 0, NULL, '2023-07-19 14:26:28', NULL, 0);
INSERT INTO `sys_oper_log` VALUES (74, '角色', 'edu.ctgu.sanxia.controller.SysRoleController', 'GET', 'MANAGE', 'zhangsan', '/admin/system/sysRole/findByPage/1/3', '0:0:0:0:0:0:0:1', NULL, '{\"code\":200,\"data\":{\"endRow\":3,\"hasNextPage\":true,\"hasPreviousPage\":false,\"isFirstPage\":true,\"isLastPage\":false,\"list\":[{\"createTime\":\"2023-07-19 14:26:28\",\"id\":35,\"isDeleted\":0,\"roleCode\":\"bbb\",\"roleName\":\"bbb\",\"updateTime\":\"2023-07-19 14:26:28\"},{\"createTime\":\"2023-07-19 14:09:32\",\"id\":34,\"isDeleted\":0,\"roleCode\":\"aaa\",\"roleName\":\"aaa\",\"updateTime\":\"2023-07-19 14:09:32\"},{\"createTime\":\"2023-07-18 14:36:22\",\"id\":33,\"isDeleted\":0,\"roleCode\":\"test\",\"roleName\":\"测试\",\"updateTime\":\"2023-07-18 14:36:22\"}],\"navigateFirstPage\":1,\"navigateLastPage\":2,\"navigatePages\":8,\"navigatepageNums\":[1,2],\"nextPage\":2,\"pageNum\":1,\"pageSize\":3,\"pages\":2,\"prePage\":0,\"size\":3,\"startRow\":1,\"total\":6},\"message\":\"操作成功\"}', 0, NULL, '2023-07-19 14:26:28', NULL, 0);
INSERT INTO `sys_oper_log` VALUES (75, '角色菜单模块:分配菜单', 'edu.ctgu.sanxia.service.impl.SysRoleMenuServiceImpl', 'POST', 'MANAGE', 'zhangsan', '/admin/system/sysRoleMenu/doAssign', '0:0:0:0:0:0:0:1', '{\"roleId\":35,\"menuIdList\":[{\"id\":2,\"isHalf\":0},{\"id\":1,\"isHalf\":1}]}', 'null', 0, NULL, '2023-07-19 14:32:54', NULL, 0);
...
INSERT INTO `sys_oper_log` VALUES (77, '角色菜单模块:分配菜单', 'edu.ctgu.sanxia.service.impl.SysRoleMenuServiceImpl', 'POST', 'MANAGE', 'zhangsan', '/admin/system/sysRoleMenu/doAssign', '0:0:0:0:0:0:0:1', '{\"roleId\":35,\"menuIdList\":[{\"id\":2,\"isHalf\":0},{\"id\":3,\"isHalf\":0},{\"id\":1,\"isHalf\":1}]}', 'null', 1, '/ by zero', '2023-07-19 14:34:23', NULL, 0);
INSERT INTO `sys_oper_log` VALUES (78, '角色菜单模块:分配菜单', 'edu.ctgu.sanxia.service.impl.SysRoleMenuServiceImpl', 'POST', 'MANAGE', 'zhangsan', '/admin/system/sysRoleMenu/doAssign', '0:0:0:0:0:0:0:1', '{\"roleId\":35,\"menuIdList\":[{\"id\":2,\"isHalf\":0},{\"id\":1,\"isHalf\":1}]}', 'null', 0, NULL, '2023-07-19 14:36:38', NULL, 0);
INSERT INTO `sys_oper_log` VALUES (79, '角色', 'edu.ctgu.sanxia.controller.SysRoleController', 'GET', 'MANAGE', 'zhangsan', '/admin/system/sysRole/findByPage/1/3', '0:0:0:0:0:0:0:1', NULL, '{\"code\":200,\"data\":{\"endRow\":3,\"hasNextPage\":true,\"hasPreviousPage\":false,\"isFirstPage\":true,\"isLastPage\":false,\"list\":[{\"createTime\":\"2023-07-19 14:26:28\",\"id\":35,\"isDeleted\":0,\"roleCode\":\"bbb\",\"roleName\":\"bbb\",\"updateTime\":\"2023-07-19 14:26:28\"},{\"createTime\":\"2023-07-19 14:09:32\",\"id\":34,\"isDeleted\":0,\"roleCode\":\"aaa\",\"roleName\":\"aaa\",\"updateTime\":\"2023-07-19 14:09:32\"},{\"createTime\":\"2023-07-18 14:36:22\",\"id\":33,\"isDeleted\":0,\"roleCode\":\"test\",\"roleName\":\"测试\",\"updateTime\":\"2023-07-18 14:36:22\"}],\"navigateFirstPage\":1,\"navigateLastPage\":2,\"navigatePages\":8,\"navigatepageNums\":[1,2],\"nextPage\":2,\"pageNum\":1,\"pageSize\":3,\"pages\":2,\"prePage\":0,\"size\":3,\"startRow\":1,\"total\":6},\"message\":\"操作成功\"}', 0, NULL, '2023-07-19 14:37:11', NULL, 0);
...
-- ----------------------------
INSERT INTO `sys_user_role` VALUES (7, 9, 1, '2023-07-18 10:59:09', '2024-06-26 14:35:27', 0);
